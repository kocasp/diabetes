...
class MeasurementsControllerTest < ActionController::TestCase
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post :create, measurement: { datetime: @measurement.datetime, type_id: @measurement.type_id, user_id: @measurement.user_id, value: @measurement.value }
    end
  ...
  test "should update measurement" do
    patch :update, id: @measurement, measurement: { datetime: @measurement.datetime, type_id: @measurement.type_id, user_id: @measurement.user_id, value: @measurement.value }
    assert_redirected_to measurement_path(assigns(:measurement))
  end
